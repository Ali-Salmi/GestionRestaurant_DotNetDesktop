...
namespace gestion_rest.Forms
{
    ...
    {
        private String cc = String.Format("Server={0}; Port={1}; User Id={2}; Password={3}; Database={4};", "localhost", 5432, "postgres", "123456", "gestion_rest");
        ...
        private void btnAjt_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    sql = @"INSERT INTO commande(heure_pay,date_comm,mode_pay,nb_pers,num_tab) VALUES ('" + DateTime.Now.ToString("HH:mm") + "','"+ date.Value.Day + "-" + date.Value.Month + "-" + date.Value.Year + "','"+comboBox1.SelectedItem+"',"+nbPerson.Value+","+idTable+");";
                    cmd = new NpgsqlCommand(sql, cnx);
                    cmd.ExecuteReader();
                    //selectioner le serveur
                    String ccc = String.Format("Server={0}; Port={1}; User Id={2}; Password={3}; Database={4};", "localhost", 5432, "postgres", "123456", "gestion_rest");
        ...
        public void affecterServeur(int idSer)
        {
            ...
            {
                cnx1.Open();
                sql1 = @"INSERT INTO affecter(date_affect,num_ser,num_tab) VALUES ('" + date.Value.Day + "-" + date.Value.Month + "-" + date.Value.Year + "'," + idSer + "," + idTable + ");";
                cmd1 = new NpgsqlCommand(sql1, cnx1);
                cmd1.ExecuteReader();
                cnx1.Close();
            }catch (Exception ex)
